...
while True:
    v_presta = float(input("Digite o valor da prestação ou 0 para encerrar: "))
    if v_presta == 0:
        break
    dias_atraso = float(input("Digite os dias de atraso: "))
    valor_pagamento = valorPagamento(v_presta, dias_atraso)
    print(f"Valor a ser pago: R$ {valor_pagamento:.2f}")
